...
class DCons {
    ...
    compare(o) {
        ...
        if (n < o._length) {
            ...
            let res = 0;
            while (ca && res == 0) {
                res = compare.compare(ca.value, cb.value);
                ca = ca.next;
                cb = cb.next;
            }
            return res;
    ...
    equiv(o) {
        if (!(o instanceof DCons || checks.isArrayLike(o)) ||
    ...
    *cycle() {
    ...
    $reduce(rfn, acc) {
        let cell = this.head;
        while (cell && !transducers.isReduced(acc)) {
    ...
    insertBefore(cell, value) {
        if (!cell) {
            errors.illegalArgs("cell is undefined");
        }
    ...
    insertBeforeNth(n, x) {
        ...
        if (n <= 0) {
            ...
            errors.ensureIndex(n, 0, this._length);
    ...
    slice(from = 0, to = this.length) {
        ...
        if (a < 0 || b < 0) {
            errors.illegalArgs("invalid indices: ${from} / ${to}");
        }
        const res = new DCons();
    ...
    splice(at, del = 0, insert) {
        ...
        if (typeof at === "number") {
            ...
            errors.ensureIndex(at, 0, this._length);
    ...
    setNth(n, v) {
        ...
        !cell && errors.illegalArgs(`index out of bounds: ${n}`);
        cell.value = v;
        return this;
    }
    nth(n, notFound) {
    ...
    shuffle(iter, rnd = random.SYSTEM) {
        if (this._length < 2)
            return this;
...
const defTranspose = (src) => new SOL((list, cell) => cell.prev ? (list.swap(cell.prev, cell), cell.prev) : cell, src);

exports.DCons = DCons;
exports.SOL = SOL;
exports.dcons = dcons;
exports.defDCons = defDCons;
exports.defMTF = defMTF;
exports.defTranspose = defTranspose;
