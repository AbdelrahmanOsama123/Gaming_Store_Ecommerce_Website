        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("cannot insert this order : ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'UPDATE orders SET user_id = ($1), price =($2) status=($3) WHERE id = ($4) RETURNING *';
                        return [4 /*yield*/, conn.query(sql, [order.user_id, order.price, order.status, id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        result = conn.query(sql, [quantity, order_id, product_id]);
                        return [4 /*yield*/, result];
                    case 2:
