      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            conn = _a.sent();
            sql =
              'INSERT INTO product (name, price ,catagory) VALUES ($1,$2,$3) RETURNING *';
            return [
              4 /*yield*/,
              conn.query(sql, [product.name, product.price, product.catagory]),
            ];
          case 2:
            result = _a.sent();
            conn.release();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            conn = _a.sent();
            sql =
              'UPDATE product SET name = ($1),price = ($2),catagory=($3) WHERE id = ($4) RETURNING *';
            return [
              4 /*yield*/,
              conn.query(sql, [
                product.name,
