...
var signUp = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var newUser, accessToken, refreshToken;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                accessToken = jsonwebtoken_1.default.sign({ user: newUser }, (process.env.TOKEN_SECRET), { expiresIn: '15s' });
                refreshToken = jsonwebtoken_1.default.sign({ user: newUser }, (process.env.TOKEN_SECRET), { expiresIn: '1d' });
...
var signIn = function (username, password) { return __awaiter(void 0, void 0, void 0, function () {
    var newUser, accessToken, refreshToken, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 1:
                ...
                accessToken = jsonwebtoken_1.default.sign({ user: newUser }, (process.env.TOKEN_SECRET), { expiresIn: '15s' });
                refreshToken = jsonwebtoken_1.default.sign({ user: newUser }, (process.env.TOKEN_SECRET), { expiresIn: '1d' });
                return [4 /*yield*/, redis_1.default.set(username + "A", accessToken)];
            case 2:
                _a.sent();
...
var getUserID = function (username) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.getUserID(username)];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result];
        }
