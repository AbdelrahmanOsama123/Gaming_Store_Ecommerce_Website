...
exports.show = show;
var create = function (order) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
var update = function (id, order) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.update(id, order)];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result];
        }
...
var addProduct = function (quantity, orderId, product_id) { return __awaiter(void 0, void 0, void 0, function () {
    var addedProduct;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.addProduct(quantity, orderId, product_id)];
            case 1:
