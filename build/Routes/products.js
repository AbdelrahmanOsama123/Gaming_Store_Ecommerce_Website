...
var products_routes = function (app) {
    app.get('/products', tokenValidate_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var result, error_1;
    ...
    ///tokenValidate
    app.put('/products/:id', tokenValidate_1.default, isAdmin_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var product, id, result, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
    ...
    ///tokenValidate
    app.delete('/products/:id', tokenValidate_1.default, isAdmin_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_6 = _a.sent();
                    res.status(400);
                    res.json("Invalid delete data from db " + error_6);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_7 = _a.sent();
                    res.status(400);
                    res.json("Invalid get trending products " + error_7);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
