...
var products_routes = function (app) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_5 = _a.sent();
                    res.status(400);
                    res.json("Invalid show data from database " + error_5);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_6 = _a.sent();
                    res.status(400);
                    res.json("Invalid update data from database " + error_6);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_7 = _a.sent();
                    res.status(400);
                    res.json("Invalid delete data from database " + error_7);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_8 = _a.sent();
                    res.status(400);
                    res.json("Invalid get products by required catagory from database " + error_8);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_9 = _a.sent();
                    res.status(400);
                    res.json("Invalid get trending products " + error_9);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
    ...
    app.post('/getProductId', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var productName, product_id, error_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                ...
                case 2:
                    error_10 = _a.sent();
                    res.status(400);
                    res.json("cannot get product_id from product model " + error_10);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_11 = _a.sent();
                    res.status(400);
                    res.json("cannot get products with offset from product models " + error_11);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
