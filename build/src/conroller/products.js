...
exports.getMostPlayed = exports.getImage = exports.saveProductImage = exports.getPageProducts = exports.getProductId = exports.getTrendingProducts = exports.getProductsByCatagory = exports.Delete = exports.update = exports.create = exports.show = exports.index = void 0;
...
var show = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                throw new Error("cannot get product ".concat(id, " ").concat(error_2));
            case 3: return [2 /*return*/];
        }
    });
}); };
...
var create = function (product) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                throw new Error("cannot insert this product ".concat(error_3));
            case 3: return [2 /*return*/];
        }
    });
}); };
exports.create = create;
var update = function (id, product) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                error_4 = _a.sent();
                throw new Error("cannot update product ".concat(id, " ").concat(error_4));
            case 3: return [2 /*return*/];
        }
    });
}); };
...
var Delete = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_5 = _a.sent();
                throw new Error("cannot delete product ".concat(id, " ").concat(error_5));
            case 3: return [2 /*return*/];
        }
    });
}); };
exports.Delete = Delete;
var getProductsByCatagory = function (catagory) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        try {
            ...
            throw new Error("cannot get ".concat(catagory, " ").concat(error));
        }
        return [2 /*return*/];
    });
}); };
exports.getProductsByCatagory = getProductsByCatagory;
var getTrendingProducts = function () { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.trendingProducts()];
            case 1:
                result = _a.sent();
                return [2 /*return*/, result];
            case 2:
...
var getMostPlayed = function () {
    try {
        var result = store.getMostPlayed();
        return result;
    }
    catch (error) {
        throw new Error('cannot get image from models ' + error);
...
exports.getMostPlayed = getMostPlayed;
